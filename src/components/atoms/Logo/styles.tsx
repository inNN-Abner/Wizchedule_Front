...
export const LogoImage = styled.Image
 <{ wdt?: string; hgt?: string; mgTop?: string; mgRight?: string; mgleft?:string;  jstCont?: string; source?: string }>`    
    ...
    marginLeft: ${({ theme, mgleft }) => (mgleft ? `${theme.metrics.px(mgleft)}px` : `${theme.metrics.px(0)}px`)};
`